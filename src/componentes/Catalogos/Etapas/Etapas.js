...
function CatalogoEtapas() {
  ...
  const handler_addAgregarEtapa = (AgregarEtapa) => {
    setCourseEtapas((prevCourseEtapas) =>
      prevCourseEtapas.concat(AgregarEtapa)
    );
  };
