    ...
    <Paper>
      <Grid container spacing={2}>
            ...
            <Grid container spacing={1}>
              ...
              <Grid item xs={12} sm={4}>
                <FormControl fullWidth>
                  <InputLabel id="selectArea_inputLabel">Puesto</InputLabel>
                  <Select
                  ...
                  >
                    <MenuItem value={10}>Puesto 1</MenuItem>
                    <MenuItem value={20}>Puesto 2</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
              <Grid item xs={12} sm={4}>
              ...
              <Grid
                className="busqueda-particulares__formulario__actions"
                item
                xs={12}
                sm={12}
              >
        ...
        <Grid className="busqueda-particulares__agregar" item xs={2}>
          <Link to="/registroparticulares" className="link">
